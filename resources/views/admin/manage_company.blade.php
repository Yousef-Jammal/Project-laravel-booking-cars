                ...
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3" style="background-image: linear-gradient(195deg, #ffa633 0%, #ffa633 100%)">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <h6 class="text-white text-capitalize ps-3">Companies Table</h6>
                            <a href="{{ route('admin_create_company') }}" class="btn btn-beautiful" style="margin-right: 20px; color: #fff;">
                                Add Company
                            </a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle" style="text-align: center">
                                        <a href="{{ route('admin_show_company', $company->id) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="View company">
                                            <img src="{{ asset('img/icons/my_eye.png') }}" style="width: 21px; margin:0 3px 0">
                                        </a>
                                        <a href="{{ route('admin_edit_company', $company->id) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit company">
                                            <img src="{{ asset('img/icons/my_edit.png') }}" style="width: 20px; margin:0 3px 0 ">
                                        </a>
                                        <a href="{{ route('admin_delete_company', $company->id) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Delete company">
