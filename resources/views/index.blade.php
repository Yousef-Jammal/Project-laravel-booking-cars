...
<div class="view-all">
{{-- <a href="{{ route('allCars') }}" class="btn btn-view d-inline-flex align-items-center">View all Cars <span><i class="feather-arrow-right ms-2"></i></span></a> --}}
</div>
</div>
<div class="col-lg-6" data-aos="fade-down">
    ...
    $(document).ready(function(){
        $('input[type="radio"]').change(function(){
            ...
            jQuery.ajax({
                ...
                datatype:'html',
                cache:false,
                data:{searchUser:searchUser, '_token':"{{csrf_token()}}"},
