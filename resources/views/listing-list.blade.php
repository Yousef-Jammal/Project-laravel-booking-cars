...
<img src="{{ asset('img/car-list-1.jpg') }}" class="img-fluid" alt="blog-img">
</a>
</div>
...
<h3><a href="listing-details.html">Ferrari 458 MM Speciale</a></h3>
...
<img src="{{ asset('img/cars/car-list-icon-01.png') }}" alt="car">
</div>
...
<div class="blog-img">
<a href="listing-details.html">
<img src="{{ asset('img/car-list-2.jpg') }}" class="img-fluid" alt="blog-img">
</a>
</div>
<div class="bloglist-content w-100">
<div class="card-body">
...
<div class="title-bottom">
<div class="car-list-icon">
<img src="{{ asset('img/cars/car-list-icon-02.png') }}" alt="Car">
</div>
<div class="address-info">
<h5><a href="#">Toyota Of Lincoln Park</a></h5>
<h6><i class="feather-map-pin me-2"></i>Newyork, USA</h6>
...
<div class="blog-img">
<a href="listing-details.html">
<img src="{{ asset('img/car-list-3.jpg') }}" class="img-fluid" alt="blog-img">
</a>
</div>
<div class="bloglist-content w-100">
<div class="card-body">
...
<div class="title-bottom">
<div class="car-list-icon">
<img src="{{ asset('img/cars/car-list-icon-03.png') }}" alt="Car">
</div>
<div class="address-info">
<h5><a href="#">Toyota Of Lincoln Park</a></h5>
<h6><i class="feather-map-pin me-2"></i>Newyork, USA</h6>
