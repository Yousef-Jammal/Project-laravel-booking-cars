        ...
        <div class="row no-gutters">
            <div class="imgcontainercardaseel col-md-4">
                @if($rental->car->images->isNotEmpty())
                    <img src="{{ asset('storage/' . $rental->car->images->first()->name) }}" class="cardimgaseel card-img" alt="{{ $rental->car->brand }}">
                @else
            ...
            <div class="col-md-8">
                <div class="aseelcardlist card-body">
                    ...
                    <div class="listAseel blog-list-head d-flex">
                        ...
                        <p class="card-text"><strong>Rental Period:</strong> {{ $rental->rent_start->format('Y-m-d') }} to {{ $rental->rent_end->format('Y-m-d') }}</p>
                    </div>
