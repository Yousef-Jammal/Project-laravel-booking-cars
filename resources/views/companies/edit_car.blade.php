                ...
                <div class="col-md-12 col-12">
                    ...
                    <nav aria-label="breadcrumb" class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ $company->user->name }} Rental Control
                                Center/ Edit </li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <div class="aseel-row">
                        ...
                        <div class="aseel-col">
                            <div class="aseel-form-group">
                                ...
                                <input type="text" name="model" class="aseel-form-control" id="model"
                    ...
                    <div class="aseel-row">
                        <div class="aseel-col">
                            <div class="aseel-form-group">
                                ...
                                <input type="text" name="body" class="aseel-form-control" id="body"
                                    value="{{ $car->body }}" required>
                            </div>
                        </div>
                        <div class="aseel-col">
                            <div class="aseel-form-group">
                    ...
                    <div class="aseel-row">
                        <div class="aseel-col">
                            <div class="aseel-form-group">
                                ...
                                <input type="number" name="door" class="aseel-form-control" id="door"
                        ...
                        <div class="aseel-col">
                            <div class="aseel-form-group">
                                ...
                                <input type="number" name="mileage" class="aseel-form-control" id="mileage"
                ...
                <div class="card-body">
                    <div class="aseel-form-group">
                        ...
                        @foreach ($car->features as $feature)
                            <input type="text" class="aseel-form-control mb-2" name="features[]"
                    ...
                    <div class="aseel-row">
                        <div class="aseel-col">
                            <div class="aseel-form-group">
                                ...
                                <input type="text" name="fuel_type" class="aseel-form-control" id="fuel_type"
                                    value="{{ $car->fuel_type }}" required>
                            </div>
                        </div>
                        <div class="aseel-col">
                            <div class="aseel-form-group">
                                <label for="make">Make</label>
                                <input type="text" name="make" class="aseel-form-control" id="make"
                    ...
                    <div class="aseel-row">
                        <div class="aseel-col">
                            <div class="aseel-form-group">
                                ...
                                <input type="text" name="transmission" class="aseel-form-control" id="transmission"
                                    value="{{ $car->transmission }}" required>
                            </div>
                        </div>
                        <div class="aseel-col">
                            <div class="aseel-form-group">
                                <label for="drivetrian">Drivetrain</label>
                                <input type="text" name="drivetrian" class="aseel-form-control" id="drivetrian"
                                    value="{{ $car->drivetrian }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="aseel-row">
                        <div class="aseel-col">
                            <div class="aseel-form-group">
                                ...
                                <input type="text" name="vin" class="aseel-form-control" id="vin"
                        ...
                        <div class="aseel-col">
                            <div class="aseel-form-group">
                                ...
                                <input type="text" name="brake" class="aseel-form-control" id="brake"
                                    value="{{ $car->brake }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="aseel-row">
                        <div class="aseel-col">
                            <div class="aseel-form-group">
                                ...
                                <input type="number" name="year" class="aseel-form-control" id="year"
                        ...
                        <div class="aseel-col">
                            <div class="aseel-form-group">
                                ...
                                <input type="number" name="engine_hp" class="aseel-form-control" id="engine_hp"
                                    value="{{ $car->engine_hp }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="aseel-row">
                        <div class="aseel-col">
                            <div class="aseel-form-group">
                                ...
                                <input type="number" name="price_per_day" class="aseel-form-control" id="price_per_day"
