...
<ul>
<li><a href="#"><img src="{{ asset('img/icons/payment-1.svg') }}" alt="Payment Icon"></a></li>
<li><a href="#"><img src="{{ asset('img/icons/payment-2.svg') }}" alt="Payment Icon"></a></li>
<li><a href="#"><img src="{{ asset('img/icons/payment-3.svg') }}" alt="Payment Icon"></a></li>
<li><a href="#"><img src="{{ asset('img/icons/payment-4.svg') }}" alt="Payment Icon"></a></li>
</ul>
<div class="booking-form">
<div class="booking-title">
<h5>Enter Below details</h5>
